...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       list.add(getString(R.string.title_section5));list.add(getString(R.string.title_section6));
        list.add(getString(R.string.title_section7));list.add(getString(R.string.title_section8));list.add(getString(R.string.title_section9));list.add(getString(R.string.title_section10));
