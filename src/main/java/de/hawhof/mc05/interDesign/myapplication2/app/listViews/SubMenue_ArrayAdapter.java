 ...
 */
public class SubMenue_ArrayAdapter<T> extends ArrayAdapter<T> {
     ...
     */
    public SubMenue_ArrayAdapter(Context context, int resource, @NonNull List<T> objects) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        final SubMenue menue = (SubMenue) this.getItem(position);
        ...
        if(menue != null) {
            ...
            subText1.setText(this.context.getResources().obtainTypedArray(menue.getSubMenues().get(0).getResourceId(0,-1)).getString(1));
            ...
            subText2.setText(this.context.getResources().obtainTypedArray(menue.getSubMenues().get(1).getResourceId(1,-1)).getString(1));
           ...
           // subText3.setText(menue.getSubMenues().get(2).getString(1));
            subText3.setText(this.context.getResources().obtainTypedArray(menue.getSubMenues().get(2).getResourceId(2,-1)).getString(1));
